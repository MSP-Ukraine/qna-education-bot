...
## Скільки одночасно профілів можна використовувати?
<details>
  <summary>Розгорнути відповідь</summary>
  
  ***
  
  На даний момент десктоп додаток надає можливість одночасно використовувати один профіль. Мобільний додаток платформи дозволяє додавати декілька профілів та з легкістю між ними перемикатися.
  
  Якщо ваш профіль було додано до іншої організації, то є можливість переходити між ними. Наприклад, викладача запросили в школу допомогти з проектом. Нижче на скріншоті зображено де знайти школу/університет/організацію до якої вас запросили.
  
  ![](resources/pictures/change-organization.jpg)
  ***
...
<details>
  <summary>Розгорнути питання</summary>
...
3.	Розгорніть поле створення за допомогою одночасного натискання клавіш <kbd>Ctrl + Shift + X</kbd> 
...
## Як змінити параметри наради/події/уроку?
<details>
  <summary>Розгорнути питання</summary>
  
  ***
  За замовчуванням створена подія не має обмежень для учасників. Будь-хто під час її проведення може перемикати слайди та вимикати мікрофони один одного. Налаштування параметрів усувають ці проблеми, можна обрати одну людину яка буде презентувати та слідкувати за мікрофонами. Ще є параметр який обмежує підключення користувачів з інших організацій. Можна обрати хто не буде чекати у фойє після підключення, а відразу долучиться до події.

Змінювати параметри наради можуть тільки організатори наради. Також ця можливість відкривається якщо до події додано хоча б одного користувача.

1. Натисніть зліва кнопку **«Календар»**
2. Оберіть подію
3. Відкриється вкладка **Відомості**, поряд з налаштуванням Часового поясу є кнопка **Параметри наради**, натиснути її
4. Йде перенаправлення на сайт з параметрами події
5. Зробіть зміни, змініть хто може вести презентацію та кому не потрібно чекати на приєднання
6. Натиснути **Зберегти**
![](/resources/meeting-options.gif)
   ***
...
## Як записати відеозустріч?
<details>
  <summary>Розгорнути питання</summary>
  
  ***
  Щоб записати нараду/урок/подію потрібно її розпочати, а далі почати запис, нижче написано як це зробити. Наприклад оберемо створену подію в **Календарі**.

1. Натисніть зліва кнопку **«Календар»**
2. Оберіть подію
3. У верхньому правому куті натисніть копку **Приєднатися**->**Приєднатися зараз**
4. Обрати **Інші дії ●●●**->**Почати записувати**, все це знаходиться на панелі керування
5. Щоб закінчити записувати натисуаємо **Інші дії ●●●**->**Закінчити записувати** та тиснемо **Роз'єднати** для завершення дзвінка
6. Відкриється **Чат** події де буде відображено запис події

Записи подій можна переглядати за допомогою сервісу **Stream**. Щоб його відкрити достатньо обрати **Інші додані програми ●●●**, знаходиться ліворуч та знайти там програму **Stream**.
![](/resources/record-meeting.gif)
