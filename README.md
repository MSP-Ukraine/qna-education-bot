...
- Загальні питання
    ...
    - [Як перевірити роботу на плагіат?](#як-перевірити-роботу-на-плагіат)
...
*	Для початку під час створення завдання для учнів, потрібно увімкнути функцію Turnitin
*	Далі учні, коли здають файли із виконаним завданням, після підтвердження відправки файлу, побачать у верхньому правому куті повідомлення про те, що їх файл було синхронізовано з Turnitin.
*	І тепер, коли вчитель буде перевіряти надіслані файли учнів, праворуч від вікна редактора буде виведено кількість балів унікальності роботи, та також можливо буде відкрити детальний звіт.
