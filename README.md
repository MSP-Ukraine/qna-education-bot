...
- Загальні питання
    ...
    - [Як створити команду?](#як-створити-команду)
    ...
    - [Елементи для створення Університету в Microsoft Teams](#елементи-для-створення-університету-в-microsoft-teams)
    ...
    - [Хто може адмініструвати команду?](#хто-може-адмініструвати-команду)
    ...
    - [Як створити тест для учнів?](#як-створити-тест-для-учнів)
    - [Для чого потрібен OneNote?](#для-чого-потрібен-onenote)
